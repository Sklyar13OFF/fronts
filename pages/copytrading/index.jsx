...
export default function CopyTrading() {
    ...
    return (
        <div>
            {isAdmin ? (
                < div className="flex flex-col w-full items-center md:h-[100vh] pt-[90px] bg-[#0B1217] justify-start" >
                    <div className=" gap-5 flex-col md:flex-row flex  items-start justify-center">
                        <div className="flex flex-col gap-5">
                            <div className="flex bg-[#142028] gap-2 rounded-lg p-4 flex-col w-[300px] h-[210px]">
        ...
        />
                ...
                <div className="grid grid-cols-4 gap-10">
                    {traders && traders.map((trader) => (
                        <div key={trader.id} className={`${myInfo &&  myInfo[trader.id] ? 'bg-[#4e758f]' : 'bg-[#142028]'} w-[300px] h-[380px] flex flex-col  rounded-xl shadow-2xl p-5  bg-[#142028]`}>
