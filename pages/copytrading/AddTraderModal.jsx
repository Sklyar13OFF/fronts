...
export default function AddTraderModal() {
  ...
  return (
    <div>
      <button
        className="w-full gradient-button h-[40px] font-bold bg-[#00A2BF] rounded-t-lg text-white"
            ...
            <div className="flex flex-col w-full items-start gap-8 p-6">
              ...
              <div className="flex gap-2">
                <div className="flex flex-col gap-4">
                  <div className="flex gap-1 items-start flex-col">
                    <label className="text-white text-sm" required>
                      Username
                    </label>
                    <input
                      onChange={(event) => setUsername(event.target.value)}
                      className="bg-[#0B1217] px-3 text-white text-sm rounded-lg shadow-lg outline-none w-[350px] h-[40px]"
                      required
                    />
                  </div>
                  <div className="flex gap-1 items-start flex-col">
                    ...
                    <input
                      ...
                      className="bg-[#0B1217] py-2 px-3 text-white text-sm rounded-lg shadow-lg outline-none w-[350px] h-[40px]"
                      required
                    />
                  </div>
                  <div className="flex gap-1 items-start flex-col">
                    ...
                    <textarea
                      ...
                      className="bg-[#0B1217] py-2 px-3 text-white text-sm rounded-lg shadow-lg outline-none w-[350px] h-[80px]"
                      required
                    ></textarea>
                  </div>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col h-[200px] overflow-y-auto bg-[#0B1217] rounded-xl">
                    <label className="text-white py-3 px-1 font-medium">
                      Trader Strategies
                    </label>
                    {strategiess &&
                      strategiess.map((strategy, index) => (
                        ...
                        >
                          ...
                          <input
                            type="number"
                            className="w-[120px] text-white p-2 h-[30px] bg-[#142028] rounded-xl outline-none"
                            onChange={(e) =>
              ...
              <div className="flex w-full justify-between mt-4">
                ...
                <button
                  ...
                  className="w-[600px] disabled:opacity-25 gradient-button h-[40px] font-bold bg-[#00A2BF] rounded-lg text-white"
                >
                  Add
                </button>
              </div>
